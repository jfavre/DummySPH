...
pythonCalculator1 = PythonCalculator(registrationName='PythonCalculator1', Input=reader)
pythonCalculator1.Expression = 'mag(make_vector(vx,vy,vz))'
pythonCalculator1.CopyArrays = 1
varname = "velocity_magnitude"

pythonCalculator1.ArrayName = varname

readerDisplay = Show(pythonCalculator1, renderView1, 'GeometryRepresentation')
...
convertToPointCloud1 = ConvertToPointCloud(registrationName='ConvertToPointCloud1', Input=pythonCalculator1)
